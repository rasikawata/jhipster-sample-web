...
@RestController
@RequestMapping("/api/jhipster-sample-web-kafka")
public class JhipsterSampleWebKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleWebKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleWebKafkaResource(KafkaProperties kafkaProperties) {
