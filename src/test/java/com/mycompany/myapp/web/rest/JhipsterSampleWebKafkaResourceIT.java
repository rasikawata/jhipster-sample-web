...
class JhipsterSampleWebKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleWebKafkaResource kafkaResource = new JhipsterSampleWebKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-web-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-web-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
